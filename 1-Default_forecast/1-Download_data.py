...
HINDDIR_DEF = os.getenv('HIND_DIR')
FOREDIR_DEF = os.getenv('FORE_DIR')

# Directory creation
for directory in [HINDDIR_DEF, FOREDIR_DEF]:
...
fcst_fname = f'{FOREDIR_DEF}/{fcst_bname}.grib'
...
hcst_fname = f'{HINDDIR_DEF}/{hcst_bname}.grib'
...
# File name for hindcast
obs_fname = f'{HINDDIR_DEF}/{obs_bname}.grib'
