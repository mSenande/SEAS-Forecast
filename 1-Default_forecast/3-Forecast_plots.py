...
anom_mean.to_netcdf(f'{FOREDIR}/{fcst_bname}-{meses}_{var}-anomaly.nc')
...
# Save to netcdf file                 
probs_forecast.to_netcdf(f'{FOREDIR}/{fcst_bname}-{meses}_{var}-probability.nc')
