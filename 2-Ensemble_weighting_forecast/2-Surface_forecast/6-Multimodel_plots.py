...
# Save to netcdf file 
anom_mean.to_netcdf(f'{NEW_FOREDIR}/{multi_fcst_bname}-{meses}_{var}-anomaly.nc')               
probs_forecast.to_netcdf(f'{NEW_FOREDIR}/{multi_fcst_bname}-{meses}_{var}-probability.nc')
...
# Read the data file
corr = xr.open_dataset(f'{NEW_SCORES_HINDDIR}/{multi_hcst_bname}.{aggr}.corr.nc')
corr_pval = xr.open_dataset(f'{NEW_SCORES_HINDDIR}/{multi_hcst_bname}.{aggr}.corr_pval.nc')
...
# Read the data file
rpss = xr.open_dataset(f'{NEW_SCORES_HINDDIR}/{multi_hcst_bname}.{aggr}.rpss.nc')
# Select forecast month
...
# Read the data file
roc = xr.open_dataset(f'{NEW_SCORES_HINDDIR}/{multi_hcst_bname}.{aggr}.roc.nc')
# Select forecast month
