...
NEW_FOREDIR = os.getenv('NEW_FORE_DIR') # Directory where forecast outputs are located
...
for m in models.index:
    ...
    anom_mean = xr.open_dataarray(f'{NEW_FOREDIR}/{fcst_bname}-{meses}_{var}-anomaly.nc')
    # Read forecasted probabilities
    probs_forecast = xr.open_dataarray(f'{NEW_FOREDIR}/{fcst_bname}-{meses}_{var}-probability.nc')               
