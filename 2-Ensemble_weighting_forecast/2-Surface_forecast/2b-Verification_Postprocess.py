# %% [markdown]
# # 2b. Compute deterministic and probabilistic scores (Verification)
...
#%%
print("2b. Compute deterministic and probabilistic scores (Verification)")
...
for aggr in ['1m','3m']:
    corr_fname = f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.corr.nc'
    corr_pval_fname = f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.corr_pval.nc'
    rps_fname = f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.rps.nc'
    rpss_fname = f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.rpss.nc'
    bs_fname = f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.bs.nc'
    roc_fname = f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.roc.nc'
    rocss_fname = f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.rocss.nc'
...
for aggr in aggr_list:
    ...
    corr.to_netcdf(f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.corr.nc')
    corr_pval.to_netcdf(f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.corr_pval.nc')
...
for aggr in aggr_list:
    ...
    rps.to_netcdf(f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.rps.nc')
    rpss.to_netcdf(f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.rpss.nc')
    bs.to_netcdf(f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.bs.nc')
    roc.to_netcdf(f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.roc.nc')
    rocss.to_netcdf(f'{NEW_SCORES_HINDDIR}/{hcst_bname}.{aggr}.rocss.nc')
