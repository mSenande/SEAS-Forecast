...
# This script is used to download monthly seasonal observations for the selected forecast and hindcast period.
# 
...
# Here we will download all the ERA5 period (1940-2020).
